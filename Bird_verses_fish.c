...
int main(void)
{
    ...
    v1 = ( n1 / n2 ) * u; // formula for apparent distance
    ...
    v2 = ( n2 / n1 ) * u; // formula for apparent distance
    ...
    printf("\nConclusion:\n\n\
     Bird locates a fish nearer from the fish's real position\n\
     while fish locates a bird farther with respect to the\n\
